...
if ($validator->isPosted()) {
    ...
    $admin->muteUser($result, $_POST['mute_period']);
    $session->setFlash('success', 'The User has been successfully banned for '. $_POST['mute_period'] .' days');
    App::redirect('Posts.php');
}
...
<div class="login-box">
    ...
    <form action="" method="post">
        <div class="user-box">
            <input type="number" name="mute_period">
